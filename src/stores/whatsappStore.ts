...
interface WhatsAppState {
  ...
  pickerContext: { leadId?: string; leadName?: string; leadPhone?: string; projectName?: string; projectLocation?: string; templateId?: string } | null;
  ...
  closeEditor: () => void;
  openPicker: (context: { leadId?: string; leadName?: string; leadPhone?: string; projectName?: string; projectLocation?: string; templateId?: string }) => void;
  closePicker: () => void;
